...
public class SnowDrawer extends BaseDrawer {
	...
	private static final float MAX_SIZE = 30f;
	...
	@Override
	protected int[] getSkyBackgroundGradient() { return isNight ? SkyBackground.SNOW_N : SkyBackground.SNOW_D; }
