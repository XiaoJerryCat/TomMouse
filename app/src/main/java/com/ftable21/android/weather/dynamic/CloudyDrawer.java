...
public class CloudyDrawer extends BaseDrawer {
	...
	public CloudyDrawer(Context context, boolean isNight) { super(context, isNight); }
	...
	public boolean drawWeather(Canvas canvas, float alpha) {
		for (CircleHolder holder : this.holders) { holder.updateAndDraw(canvas, paint, alpha); }
		return true;
	}

	@Override
	protected int[] getSkyBackgroundGradient() { return isNight ? SkyBackground.CLOUDY_N : SkyBackground.CLOUDY_D; }
