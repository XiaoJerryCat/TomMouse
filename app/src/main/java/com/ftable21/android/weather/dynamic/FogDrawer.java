...
public class FogDrawer extends BaseDrawer {
	...
	public FogDrawer(Context context, boolean isNight) { super(context, isNight); }
	...
	@Override
	protected int[] getSkyBackgroundGradient() { return isNight ? SkyBackground.FOG_N : SkyBackground.FOG_D; }
}
